...
public class DBBuilder {
    ...
    protected void execSQL(SQLiteDatabase db, String sql) throws ScanCancelledException {
        if (scannerService.isScanCancellationRequested()) {
    ...
    protected long insert(SQLiteDatabase db, String table, ContentValues values) throws ScanCancelledException {
        if (scannerService.isScanCancellationRequested()) {
            throw new ScanCancelledException();
        } else {
