...
public class TrackArrayAdapter extends BaseArrayAdapter<Track> {
    public TrackArrayAdapter(Context context, int textViewResourceId, List<MediaList.PrefixOffset> prefixOffsets) {
