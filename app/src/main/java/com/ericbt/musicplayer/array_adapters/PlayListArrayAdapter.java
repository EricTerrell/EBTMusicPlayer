...
public class PlayListArrayAdapter extends BaseArrayAdapter<PlayList> {
    public PlayListArrayAdapter(Context context, int textViewResourceId, List<MediaList.PrefixOffset> prefixOffsets) {
